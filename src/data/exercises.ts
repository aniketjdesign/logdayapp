...
export const exercises: Exercise[] = [
  ...
  { id: 'q1', name: 'Bodyweight Sumo Squats', muscleGroup: 'Quads' },
  { id: 'q1', name: 'Bodyweight Goblet Squats', muscleGroup: 'Quads' },
  ...
  { id: 'q5', name: 'Sumo Squat (Dumbbell)', muscleGroup: 'Quads' },
  ...
  { id: 'q14', name: 'Leg Press (Generic)', muscleGroup: 'Quads' },
  { id: 'q15', name: 'Leg Press (Hammer)', muscleGroup: 'Quads' },
