...
export const AddExerciseModal: React.FC<AddExerciseModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col">
      ...
      <div className="relative mt-auto bg-white rounded-t-xl max-h-[90vh] flex flex-col">
        {/* Header - Fixed */}
        <div className="flex flex-row space-x-4 items-center p-4 border-b border-gray-100">
          <h2 className="text-lg font-semibold">Add Custom Exercise</h2>
          <span className="px-1.5 py-0.5 h-content text-xs font-medium bg-blue-50 text-blue-700 rounded">Beta</span>
        </div>
        ...
        <div className="flex-1 overflow-y-auto">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Footer - Fixed */}
            <div className="sticky bottom-0 bg-white flex justify-end gap-2 pt-4 px-4 pb-4 border-t mt-4">
              <button
                type="button"
                onClick={onClose}
