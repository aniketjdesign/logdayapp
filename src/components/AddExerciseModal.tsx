  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
        <div className="bg-white rounded-xl w-full max-w-md max-h-[90vh] flex flex-col pointer-events-auto">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
            ...
            <div className="flex justify-end gap-2 pt-4 px-4 pb-2 border-t mt-4">
              <button
                type="button"
                onClick={onClose}
