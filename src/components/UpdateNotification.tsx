...
export function UpdateNotification({ 
  ...
  return (
    <div className="fixed top-0 left-1/2 transform -translate-x-1/2 z-[9999] max-w-md w-full bg-blue-600 text-white p-4 rounded-b-2xl shadow-lg flex justify-between items-center animate-fade-in">
