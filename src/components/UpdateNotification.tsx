...
export function UpdateNotification({ 
  ...
  return (
    <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-[9999] max-w-md w-full mx-2 bg-blue-600 text-white p-4 rounded-lg shadow-lg flex justify-between items-center animate-fade-in">
