...
export const RestTimer: React.FC<RestTimerProps> = ({
  ...
  const progress =
    ((initialDurationRef.current - timeLeft) / initialDurationRef.current) *
    100;
  ...
  return (
    <div
      className="fixed inset-x-0 bottom-0 z-50 bg-white rounded-3xl shadow-lg animate-slide-up mx-4 mb-12"
      style={{ height: 'auto' }}
    >
